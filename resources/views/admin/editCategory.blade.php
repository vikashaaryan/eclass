        ...
        <div class="w-8/12 m-6">
            <div>
                <div class="flex justify-between mb-6">
                    <h2 class="text-2xl font-semibold">Edit   {{$category->cat_title}}'s' Category</h2>
                ...
                <form action="{{ route('categories.update', $category) }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="cat_description" id="cat_description" rows="4"
                            class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm p-2 focus:outline-none focus:ring focus:border-blue-500">{{  $category->cat_description}}</textarea>
